...
{
	// Test 1 : Empty list
	std::string testName = "empty list"
	std::cout << SPACE << testName << SPACE << "\n";
	VLVector<int, STATIC_CAP> vec;
	RETURN_ASSERT_TRUE(vec.size() == 0)
	cout << SUCCESS_INTRO << testName << SUCCESS_END;
}

int testsSizeListOnStack()
{
	// Test 1 : Empty list
	std::string testName = "List on stack memory"
	std::cout << SPACE << testName << SPACE << "\n";
	VLVector<int, STATIC_CAP> vec;
...
{
	// Test 1 : Empty list
	std::string testName = "List on heap memory"
	std::cout << SPACE << testName << SPACE << "\n";
	VLVector<int, STATIC_CAP> vec;
...
{
	std::string testName = "List on heap memory after 5 allocations"
	std::cout << SPACE << testName << SPACE << "\n";
	VLVector<int, STATIC_CAP> vec;
